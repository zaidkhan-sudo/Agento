        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 max-w-7xl mx-auto">
            {items.map((item, index) => (
                <div
                    key={index}
                    className={cn(
                        "group relative min-h-[220px] p-6 rounded-xl overflow-hidden transition-all duration-300",
                    ...
                    <div className="relative flex flex-col space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            {item.status && (
                                <span
                                    className={cn(
                                        "text-sm font-medium px-2.5 py-1 rounded-lg backdrop-blur-sm",
                        ...
                        <div className="space-y-2">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 tracking-tight text-[20px] leading-tight">
                                {item.title}
                                {item.meta && (
                            ...
                            <p className="text-[17px] text-gray-600 dark:text-gray-300 leading-snug font-[425]">
                                {item.description}
                            </p>
                        </div>
